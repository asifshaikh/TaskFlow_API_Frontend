  ...
  return (
    <div>
      <div className='min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8'>
        {/* Back button: sticky inside the scroll container so it stays visually fixed */}
        <div className='sticky top-8 z-30'>
          <button
            onClick={() => navigate('/')}
            className='ml-6 md:ml-24 px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-md shadow hover:bg-gray-300 dark:hover:bg-gray-600 transition'
          >
            <IoArrowBack size={20} />
          </button>
        </div>
