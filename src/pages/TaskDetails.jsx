        ...
        <div className="fixed bottom-40 right-20 flex flex-col gap-3">
          ...
          {!isEditing && (
            <button
              ...
              className="p-3 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 shadow-md hover:shadow-lg hover:from-purple-500 hover:to-blue-600 transform hover:scale-[1.05]"
              title="Edit Task"
            >
              <FiEdit2 size={18} />
            </button>
